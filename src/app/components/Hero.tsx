  ...
  return (
        <section className="bg-[#F3ECE3] py-16 ">
          ...
          <div className="">
            ...
            <div className='flex'>
              <Image width = {40} height={40} src="arrow.svg" alt="" className='ml-auto rotate-180' onClick={() => setActiveTrafficSign((prev) => Math.max(prev - 1, 1))}/>
              <Image height = {40} width={40} src="arrow.svg" alt="" className='mr-[8rem]' onClick={() => setActiveTrafficSign((prev) => Math.min(prev + 1, 3))}/>
            </div>
          </div>
...
function TrafficLightSection({ heading,desc, isActive }: { heading: string; desc: string, isActive: boolean }) {
  return (
    ...
    <div className="flex flex-col justify-start gap-2">
      <Image width={1} height={1} src={isActive ? "/traffic_light.svg" : "/traffic_light_dim.svg"} alt="Traffic Light" className='w-[20rem]'/>
